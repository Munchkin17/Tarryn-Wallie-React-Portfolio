          ...
          <Col size={12} md={6}>
            <TrackVisibility>
              {({ isVisible }) =>
                ...
                <h2>Get In Touch</h2>
                <form action="https://getform.io/f/9e1e7413-a67e-4a40-a0cf-ebc7799d7e4f" method="POST" onSubmit={handleSubmit}>
                  <Row>
                    ...
                    <Col size={12} sm={6} className="px-1">
                      <input type="text" name="sname" value={formDetails.lasttName} placeholder="Last Name" onChange={(e) => onFormUpdate('lastName', e.target.value)}/>
                    </Col>
                    <Col size={12} sm={6} className="px-1">
